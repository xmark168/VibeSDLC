...
import { type ProjectsListProjectsResponse, ProjectsService } from "@/client"
...
function ProjectsPage() {
  ...
  const { data: listProjectPublic, isLoading } =
    useQuery<ProjectsListProjectsResponse>({
              ...
              {projectLimit !== null &&
                ...
                projectLimit !== -1 && (
                  <>
                    ...
                    <Link
                      to="/upgrade"
                      search={{ status: undefined, orderCode: undefined }}
                    >
                      <AttractButton
                        content={
                          isAtLimit
