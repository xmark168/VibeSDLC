...
import { ClipboardList, Workflow, Code, CheckCircle } from "lucide-react"
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <agent.icon className={`w-10 h-10 ${agent.iconColor}`} strokeWidth={2.5} />
                                ...
                                >
                                    <span className="text-sm font-medium text-purple-600 whitespace-nowrap">{agent.name}</span>
                                </motion.div>
                            </motion.div>
                        </motion.div>
                    )
