                ...
                <div className="flex gap-3 justify-center">
                    {otp.map((digit, index) => (
                        <motion.input
                            ...
                            className={`w-12 h-14 text-center text-2xl font-bold rounded-lg border-2 bg-secondary/50 transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary ${error ? "border-red-500" : "border-border"
                ...
                >
                    ...
                    {resendTimer > 0 ? (
                        ...
                        <button
                            ...
                            className="text-foreground underline hover:text-accent transition-colors font-medium"
                        >
                            Resend Code
                        </button>
                    )}
