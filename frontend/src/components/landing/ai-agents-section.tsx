            ...
            <div className="relative max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-purple-300">Meet Our AI Team</span>
                    </motion.div>
                    ...
                    >
                        Specialized AI agents collaborate seamlessly to deliver exceptional results
                    </motion.p>
                </div>
            ...
            >
                ...
                <div className="relative rounded-3xl overflow-hidden">
                    ...
                    <div className="relative p-8">
                        ...
                        {/* Agent Name and Role */}
                        <div className="mb-6">
                            <h2 className="text-4xl font-bold text-foreground mb-2">{agent.name}</h2>
