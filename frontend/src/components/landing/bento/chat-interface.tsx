...
export default function ChatInterface() {
    ...
    useEffect(() => {
        const chatInterval = setInterval(() => {
            ...
            setMessages(prev => [...prev.slice(-2), sampleMessages[Math.floor(Math.random() * sampleMessages.length)]]);
        }, 3000);
            ...
            <div className="relative p-6 h-full flex flex-col">
                ...
                <div className="flex-1 space-y-3 overflow-hidden">
                    {messages.map((msg, idx) => (
                        <div key={idx} className="bg-[#3a3b3a] rounded-xl p-3 border border-[#4a4b4a] animate-slide-up">
                ...
                <div className="mt-4 flex items-center gap-2 text-[#9ca3af] text-sm">
                    <div className="flex gap-1">
                        <div className="w-2 h-2 bg-[#5cf6d5] rounded-full animate-bounce" style={{ animationDelay: '0s' }} />
                        <div className="w-2 h-2 bg-[#5cf6d5] rounded-full animate-bounce" style={{ animationDelay: '0.2s' }} />
                        <div className="w-2 h-2 bg-[#5cf6d5] rounded-full animate-bounce" style={{ animationDelay: '0.4s' }} />
                    </div>
