                    ...
                    <div className="flex-1 space-y-3">
                        <div className="bg-[#3a3b3a] border border-[#10b981]/30 rounded-lg p-3 backdrop-blur-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[#10b981] font-medium text-sm">Unit Tests</span>
                            </div>
                            <div className="text-[#9ca3af] text-xs mt-1">All 152 tests passing</div>
                        </div>

                        <div className="bg-[#3a3b3a] border border-[#10b981]/30 rounded-lg p-3 backdrop-blur-sm">
                            <div className="flex items-center gap-2">
                                <div className="w-2 h-2 bg-[#10b981] rounded-full" />
                                <span className="text-[#10b981] font-medium text-sm">Integration Tests</span>
                            </div>
                            <div className="text-[#9ca3af] text-xs mt-1">87/87 tests successful</div>
                        </div>
                        ...
                        <div className="bg-[#3a3b3a] border border-[#f59e0b]/30 rounded-lg p-3 backdrop-blur-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[#f59e0b] font-medium text-sm">E2E Tests</span>
                            </div>
                            <div className="text-[#9ca3af] text-xs mt-1">Running 23/45 tests</div>
                        </div>
                    </div>
                </div>
            </div>
