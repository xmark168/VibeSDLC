...
const OneClickIntegrationsIllustration: React.FC<OneClickIntegrationsIllustrationProps> = ({ className = "" }) => {
    ...
    const LogoBox: React.FC<{
        ...
        const boxStyle: React.CSSProperties = {
            ...
            position: "relative",
            borderRadius: "9px",
            border: `1px ${(themeVars as Record<string, string>)["--oci-border-color"]} solid`,
            display: "flex",
        ...
        if (isGradientBg) {
            boxStyle.background = `linear-gradient(180deg, ${(themeVars as Record<string, string>)["--oci-gradient-light-gray-start"]} 0%, ${(themeVars as Record<string, string>)["--oci-gradient-light-gray-end"]} 100%)`
            boxStyle.boxShadow = `0px 1px 2px ${(themeVars as Record<string, string>)["--oci-shadow-color"]}`
    ...
    return (
        ...
        >
            ...
            ${(themeVars as Record<string, string>)["--oci-foreground-color"]}00 0%, 
            ${(themeVars as Record<string, string>)["--oci-foreground-color"]}F5 15%, 
            ${(themeVars as Record<string, string>)["--oci-foreground-color"]}66 49%, 
            ${(themeVars as Record<string, string>)["--oci-foreground-color"]}F5 87%, 
            ${(themeVars as Record<string, string>)["--oci-foreground-color"]}00 100%)`,
                }}
            />
