...
Revision ID: 07235d5b604e
Revises: 
Create Date: 2025-12-14 09:42:40.600812
...
def upgrade():
    ...
    sa.Column('tokens_used_total', sa.Integer(), nullable=False),
    ...
    sa.Column('extra_metadata', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['agent_id'], ['agents.id'], name='fk_agent_executions_agent_id', ondelete='SET NULL', use_alter=True),
    sa.ForeignKeyConstraint(['pool_id'], ['agent_pools.id'], name='fk_agent_executions_pool_id', ondelete='SET NULL', use_alter=True),
    ...
    sa.Column('agent_state', sa.Enum('PENDING', 'PROCESSING', 'PAUSED', 'CANCEL_REQUESTED', 'CANCELED', 'FINISHED', name='storyagentstate'), nullable=True),
    ...
    sa.Column('pr_state', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True),
