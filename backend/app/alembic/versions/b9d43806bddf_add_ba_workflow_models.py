...
Revision ID: b9d43806bddf
Revises: 
Create Date: 2025-11-27 00:05:29.076868
...
def upgrade():
    ...
    # Add foreign key constraint for projects.active_agent_id after agents table is created
    op.create_foreign_key('fk_projects_active_agent_id', 'projects', 'agents', ['active_agent_id'], ['id'], ondelete='SET NULL')
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('order_type', sa.Enum('SUBSCRIPTION', 'ADDON', name='ordertype'), nullable=False),
    sa.Column('subscription_id', sa.Uuid(), nullable=True),
