...
def upgrade():
    ...
    op.create_index(
        op.f("ix_agent_metrics_snapshots_pool_name"),
        "agent_metrics_snapshots",
        ["pool_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_metrics_snapshots_snapshot_timestamp"),
        "agent_metrics_snapshots",
        ["snapshot_timestamp"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "communication_style", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_agent_persona_templates_name"),
        "agent_persona_templates",
        ["name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_persona_templates_role_type"),
        "agent_persona_templates",
        ["role_type"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "epic_status",
            sa.Enum("PLANNED", "IN_PROGRESS", "COMPLETED", name="epicstatus"),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.id"],
            name="fk_epics_project_id",
            ondelete="CASCADE",
            use_alter=True,
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "full_name", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "pool_type", sa.Enum("FREE", "PAID", name="pooltype"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_agent_pools_is_active"), "agent_pools", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_agent_pools_pool_type"), "agent_pools", ["pool_type"], unique=False
    )
    op.create_index(
        op.f("ix_agent_pools_role_type"), "agent_pools", ["role_type"], unique=False
    )
    op.create_table(
        "agents",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column("personality_traits", sa.JSON(), nullable=True),
        sa.Column(
            "communication_style", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("persona_metadata", sa.JSON(), nullable=True),
        sa.Column(
            "status",
        ...
        sa.ForeignKeyConstraint(
            ["persona_template_id"], ["agent_persona_templates.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["pool_id"],
            ["agent_pools.id"],
            name="fk_agents_pool_id",
            ondelete="SET NULL",
            use_alter=True,
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_agent_pool_metrics_period_start"),
        "agent_pool_metrics",
        ["period_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_pool_metrics_pool_id"),
        "agent_pool_metrics",
        ["pool_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "question_type",
            sa.Enum("OPEN", "MULTICHOICE", "APPROVAL", name="questiontype"),
            nullable=True,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.id"],
            name="fk_agent_questions_project_id",
            ondelete="CASCADE",
            use_alter=True,
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_artifact_id"], ["artifacts.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.id"],
    ...
    op.create_table(
        ...
        sa.Column("project_id", sa.UUID(), nullable=False),
        sa.Column(
            "author_type", sa.Enum("USER", "AGENT", name="authortype"), nullable=False
        ),
        sa.Column("user_id", sa.Uuid(), nullable=True),
        sa.Column("agent_id", sa.Uuid(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "order_type",
            sa.Enum("SUBSCRIPTION", "CREDIT", name="ordertype"),
            nullable=False,
        ),
        sa.Column("subscription_id", sa.Uuid(), nullable=True),
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "PAID", "FAILED", "CANCELED", name="orderstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_orders_payos_order_code"), "orders", ["payos_order_code"], unique=True
    )
    op.create_table(
        "projects",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column(
            "project_path", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["active_agent_id"], ["agents.id"], ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.id"],
            name="fk_agent_executions_project_id",
            ondelete="CASCADE",
            use_alter=True,
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["wallet_id"], ["credit_wallets.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("USER_STORY", "ENABLER_STORY", name="storytype"),
            nullable=False,
        ),
        sa.Column("title", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column(
            "status",
            sa.Enum(
                "TODO", "IN_PROGRESS", "REVIEW", "DONE", "ARCHIVED", name="storystatus"
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "agent_state",
            sa.Enum(
                "PENDING", "PROCESSING", "CANCELED", "FINISHED", name="storyagentstate"
            ),
            nullable=True,
        ),
        sa.Column("assigned_agent_id", sa.Uuid(), nullable=True),
        sa.Column(
            "branch_name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_stories_project_id"), "stories", ["project_id"], unique=False
    )
    op.create_table(
        "workflow_policies",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column("project_id", sa.Uuid(), nullable=False),
        sa.Column(
            "from_status", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
            "to_status", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column("criteria", sa.JSON(), nullable=True),
        sa.Column(
            "required_role", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_workflow_policies_project_id"),
        "workflow_policies",
        ["project_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.id"],
            name="fk_agent_conversations_project_id",
            ondelete="CASCADE",
            use_alter=True,
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("content", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.ForeignKeyConstraint(
            ["backlog_item_id"], ["stories.id"], ondelete="CASCADE"
        ),
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_agent_conversations_project_id"), table_name="agent_conversations"
    )
    op.drop_table("agent_conversations")
    op.drop_index(
        op.f("ix_workflow_policies_project_id"), table_name="workflow_policies"
    )
    ...
    op.drop_index(
        op.f("ix_agent_pool_metrics_pool_id"), table_name="agent_pool_metrics"
    )
    op.drop_index(
        op.f("ix_agent_pool_metrics_period_start"), table_name="agent_pool_metrics"
    )
    ...
    op.drop_index(
        op.f("ix_agent_persona_templates_role_type"),
        table_name="agent_persona_templates",
    )
    op.drop_index(
        op.f("ix_agent_persona_templates_name"), table_name="agent_persona_templates"
    )
    op.drop_table("agent_persona_templates")
    op.drop_index(
        op.f("ix_agent_metrics_snapshots_snapshot_timestamp"),
        table_name="agent_metrics_snapshots",
    )
    op.drop_index(
        op.f("ix_agent_metrics_snapshots_pool_name"),
        table_name="agent_metrics_snapshots",
