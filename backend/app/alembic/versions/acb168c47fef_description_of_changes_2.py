...
Revision ID: acb168c47fef
Revises: 
Create Date: 2025-11-28 00:03:29.003626
...
def upgrade():
    ...
    sa.Column('persona_metadata', sa.JSON(), nullable=True),
    sa.Column('status', sa.Enum('created', 'starting', 'running', 'idle', 'busy', 'stopping', 'stopped', 'error', 'terminated', name='agentstatus'), nullable=True),
    sa.ForeignKeyConstraint(['persona_template_id'], ['agent_persona_templates.id'], ondelete='RESTRICT'),
    sa.ForeignKeyConstraint(['pool_id'], ['agent_pools.id'], ondelete='SET NULL'),
