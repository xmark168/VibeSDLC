...
_fast_llm = ChatOpenAI(model="claude-sonnet-4-20250514", temperature=0.1, timeout=15)
_chat_llm = ChatOpenAI(model="claude-sonnet-4-20250514", temperature=0.7, timeout=30)
