"""
Test validator only without importing agent dependencies.
"""
...
# Import only the validator function directly (bypass __init__.py)
import importlib.util

spec = importlib.util.spec_from_file_location(
    "validators", "app/agents/developer/implementor/utils/validators.py"
)
validators_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(validators_module)
validate_implementation_plan = validators_module.validate_implementation_plan
...
def main():
    ...
    print("🚀 Testing Nested Format Support in Validator...\n")
    ...
    if success:
        print("\n🎉 Validator now supports both nested and flat formats!")
