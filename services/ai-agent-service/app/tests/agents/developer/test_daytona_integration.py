...
from agents.developer.daytona.adapters import (
    get_filesystem_adapter,
    get_git_adapter
)
from agents.developer.daytona.adapters.filesystem_adapter import LocalFilesystemAdapter
from agents.developer.daytona.adapters.git_adapter import LocalGitAdapter
...
class TestLocalModeIntegration:
    ...
    def test_filesystem_adapter_local_mode(self, mock_env_daytona_disabled, temp_working_directory):
...
class TestDaytonaModeIntegration:
    ...
    def test_filesystem_adapter_daytona_mode(
        ...
        # Verify correct adapter type
        from agents.developer.daytona.adapters.filesystem_adapter import DaytonaFilesystemAdapter
    ...
    def test_git_adapter_daytona_mode(
        ...
        # Verify correct adapter type
        from agents.developer.daytona.adapters.git_adapter import DaytonaGitAdapter
...
class TestSandboxLifecycle:
    ...
    def test_sandbox_creation_and_cleanup(
        ...
        from agents.developer.implementor.nodes.setup_branch import _initialize_daytona_sandbox
        ...
        with patch('agents.developer.implementor.nodes.finalize.DaytonaConfig') as mock_cleanup_config:
            with patch('agents.developer.implementor.nodes.finalize.get_sandbox_manager') as mock_cleanup_manager:
